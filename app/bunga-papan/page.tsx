        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-800 dark:text-[#C6BBAE] mb-8 max-w-4xl mx-auto leading-relaxed">
              Kami spesialis dalam pembuatan segala jenis <span className="font-bold">bunga papan</span> & <span className="font-bold">karangan bunga</span>, seperti <span className="font-bold">bunga papan dukacita</span>, <span className="font-bold">bunga papan selamat & sukses</span> dan <span className="font-bold">bunga papan pernikahan</span>.{" "}
