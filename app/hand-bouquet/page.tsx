        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-800 dark:text-[#C6BBAE] mb-8 max-w-4xl mx-auto leading-relaxed">
              Kami spesialis dalam pembuatan segala jenis <span className="font-bold">hand bouquet</span> & <span className="font-bold">karangan bunga</span> dengan <span className="font-bold">kualitas bunga terbaik</span>. Rangkaian hand bouquet kami adalah <span className="font-bold">hadiah sempurna</span> bagi pasangan/keluarga Anda!{" "}
              <span className="font-semibold text-[#8B5A9F] dark:text-[#BFA2DB]">Pengerjaan hanya 2 jam dan gratis ongkir area Surabaya.</span>
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-800 dark:text-[#C6BBAE] mb-6">
                Popo Florist adalah solusi utama bagi Anda yang mencari jasa Bunga Papan & segala jenis hiasan bunga, seperti Bunga pernikahan, Bunga selamat, Bunga Dukacita, bunga papan mini, bunga salib dan bunga potong pita. Kami berdedikasi untuk selalu memberikan yang terbaik bagi pelanggan kami.
              </p>
              <p className="text-gray-800 dark:text-[#C6BBAE] mb-6">
                Berdiri pada tahun 2012 di Surabaya, perusahaan kami sudah sangat berpengalaman di bidang karangan bunga. Sejak 2012, kami sudah melayani ratusan client karangan bunga, dengan jaminan kualitas yang terbaik dan pastinya harga yang bersahabat !
              </p>
              <div className="mt-6">
                <WhatsAppButton
      ...
      <section className="relative py-12 bg-[#CDB6BD] dark:bg-[#2F3134] overflow-hidden rounded-b-[3rem]">
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-800 dark:text-[#C6BBAE] mb-6">
